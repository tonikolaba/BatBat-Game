...
public class Level1AState extends GameState {
	...
	private HUD hud;
	private BufferedImage angelspop;
	private Title title;
	...
	public void init() {
		...
		try {
			...
			title.sety(60);
			subtitle = new Title(angelspop.getSubimage(0, 20, 82, 13));
			subtitle.sety(85);
		}
		catch(Exception e) {
			e.printStackTrace();
...
///////////////////////////////////////////////////////
	...
	private void reset() {
		...
		eventStart = true;
		eventStart();
		title = new Title(angelspop.getSubimage(0, 0, 178, 20));
		title.sety(60);
		subtitle = new Title(angelspop.getSubimage(0, 33, 91, 13));
		subtitle.sety(85);
	}
